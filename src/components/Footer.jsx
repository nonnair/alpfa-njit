    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-section">
            ...
            <p className="footer-text">
              Empowering students to reach their full potential in accounting,
          ...
          <div className="footer-section">
            ...
            <p className="footer-text">
              <a
                href="mailto:alpfanjit@gmail.com"
            ...
            <p className="footer-text">
              <a
                href="https://alpfa.org/"
                target="_blank"
                rel="noopener noreferrer"
                className="alpfa-link"
              >
                ALPFA National Website
              </a>
            </p>
          </div>
        ...
        <div className="footer-bottom">
          <p>
            &copy; 2024 ALPFA NJIT | Website designed by IT Committee 2025–2026.
          </p>
        </div>
      </div>
    </footer>
